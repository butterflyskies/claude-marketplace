...
5. Acknowledge MINIMALLY — a single react (e.g. 🤐 or ✅) on the directive, or one short line at most. A squelch acknowledgment must not itself be chatter.
...
3. No announcement needed — silent return to normal. (Optional: a single quiet react where the directive was given.)
